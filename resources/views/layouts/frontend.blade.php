...
<head>
    ...
    <title>@yield("title","Laravel Eğitim Seti")</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="{{asset("assets/frontend/images/favicon.ico")}}"/>
    <!-- Font Awesome -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mu-single-footer">
                        <img class="mu-footer-logo" src="{{asset("assets/frontend/images/logo.png")}}" alt="logo">
